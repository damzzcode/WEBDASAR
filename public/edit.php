...
{   
    ...
    // update user data
    $result = mysqli_query($conn, "UPDATE data_diri SET nim='$nim',nama='$nama',jns_kelamin='$jns_kelamin',tmpt_lahir='$tmpt_lahir',alamat='$alamat' WHERE id=$id");
