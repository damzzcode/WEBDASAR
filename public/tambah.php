...
<div class="col-lg-4 col-xxl-4 my-5 mx-auto">
    ...
    if(isset($_POST['tambah'])) {
        ...
        $sql = "INSERT INTO `data_diri`
                (`nim`,`nama`,`jns_kelamin`,`tmpt_lahir`,`tgl_lahir`,`alamat`)
                VALUES
                ('$nim','$nama','$jns_kelamin','$tmpt_lahir','$tgl_lahir','$alamat')";
    ...
    <form class="row needs-validation" action="tambah.php" method="post" novalidate>
        ...
        <div class="col-md-12">
            ...
            <select class="form-select" id="validationCustom03" name="jns_kelamin" required>
        ...
        <div class="col-md-12">
            ...
            <input type="text" class="form-control" id="validationCustom04" name="tmpt_lahir" required>
            <div class="valid-feedback">
            Looks good!
            </div>
        </div>
